...
const CONVERSATIONS: Conversation[] = [
  { id: '1', name: 'Dr. Michael Chen', lastMessage: 'Your lab results look great.', time: '2:30 PM', unread: 1, online: true },
  { id: '2', name: 'Dr. Amara Okafor', lastMessage: 'Please remember to apply the cream twice daily.', time: 'Yesterday', unread: 0, online: false },
  { id: '3', name: 'Dr. Emily Watson', lastMessage: 'See you at your next appointment!', time: 'Mar 15', unread: 0, online: true },
];

const MESSAGES: Record<string, Msg[]> = {
  '1': [
    { id: '1', sender: 'them', content: 'Hi Sarah, I\'ve reviewed your recent blood work.', time: '2:15 PM' },
    { id: '2', sender: 'them', content: 'Your lab results look great. No concerns at this time.', time: '2:30 PM' },
    { id: '3', sender: 'me', content: 'That\'s wonderful news, thank you Dr. Chen!', time: '2:32 PM' },
    { id: '4', sender: 'them', content: 'You\'re welcome. Keep up the good work with your medication routine. We\'ll do another check in 3 months.', time: '2:35 PM' },
  ],
  '2': [
    { id: '1', sender: 'them', content: 'Hi Sarah, how is the treatment going?', time: '9:00 AM' },
    { id: '2', sender: 'me', content: 'Much better! The rash is clearing up.', time: '9:15 AM' },
    { id: '3', sender: 'them', content: 'Please remember to apply the prescribed cream twice daily.', time: '9:20 AM' },
  ],
  '3': [
    { id: '1', sender: 'them', content: 'Your annual checkup went well. See you at your next appointment!', time: '11:00 AM' },
  ],
};
...
export default function SecureMessaging() {
  ...
  const sendMessage = () => {
    ...
    // Simulate reply
    setTimeout(() => {
      const reply: Msg = { id: (Date.now() + 1).toString(), sender: 'them', content: 'Thank you for your message. I\'ll review and get back to you shortly.', time: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }) };
        ...
        <div className={`w-full md:w-80 border-r flex flex-col ${!showConvos && 'hidden md:flex'}`}>
          ...
          <div className="flex-1 overflow-y-auto">
            {filteredConvos.map(c => (
              <button
                key={c.id}
                onClick={() => { setActiveConvo(c.id); setShowConvos(false); }}
            ...
            <>
              <div className="h-14 border-b flex items-center justify-between px-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="h-8 w-8 rounded-full bg-primary/10 flex items-center justify-center text-primary font-bold text-xs">
                    {activeConversation.name.split(' ').slice(1).map(n => n[0]).join('')}
                  </div>
                  <div>
              ...
              <div className="border-t p-3 flex gap-2">
                ...
                <Input
                  ...
                  className="flex-1"
                />
                <Button size="icon" className="h-10 w-10 shrink-0" onClick={sendMessage} disabled={!newMessage.trim()}>
